...
<body>
    <form id="Form" class="Form" action="maid_confirmprice.php" method="POST">
        <?php if(isset($_POST["submit"])){ ?>
        <div> Z<?php echo $cur_job_id; ?></div>
        <div>
        	แม่บ้านจำนวน <select style="width:50px" name="no_of_maids" id="no_of_maids"> 
     	...
     	<span>
       		<input class="inputtext" name="price" id="price" placeholder="" />
       	</span>
       	</div>
       	<!--
       	<div class="text">
            โน๊ตเพิ่มเติม <textarea rows="5" name="quot_comment" class="advancedSearchTextBox"></textarea>
        </div> -->
